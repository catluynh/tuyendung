...
function thanhToan() {
    try {
        ...
        const create_payment_json = {
            ...
            "redirect_urls": {
                "return_url": "ec2-54-179-0-126.ap-southeast-1.compute.amazonaws.com:3000/success",
                "cancel_url": "ec2-54-179-0-126.ap-southeast-1.compute.amazonaws.com:3000/cancel"
            },
            "transactions": [{
                "item_list": {
                    "items": items
