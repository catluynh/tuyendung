...
function thanhToan() {
    try {
        ...
        const create_payment_json = {
            ...
            "redirect_urls": {
                "return_url": "http://ec2-3-0-177-195.ap-southeast-1.compute.amazonaws.com:3000/success",
                "cancel_url": "http://ec2-3-0-177-195.ap-southeast-1.compute.amazonaws.com:3000/cancel"
            },
            "transactions": [{
                "item_list": {
                    "items": items
