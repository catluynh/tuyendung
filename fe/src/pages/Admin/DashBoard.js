...
const MainNavigationAdmin = () => {
  ...
  const getDataListFilters = async () => {
    const requestUrl = `ec2-54-179-0-126.ap-southeast-1.compute.amazonaws.com:4000/tinTuyenDungs/timKiemTheoNhaTuyenDung?${paramsString}`;
    try {
  ...
  const handleAddButtonClickDetailStop = async (id) => {
    try {
      const requestUrl = `ec2-54-179-0-126.ap-southeast-1.compute.amazonaws.com:4000/tinTuyenDungs/dungTuyen/${id}`;
