...
const AllProfilePage = () => {
  ...
  const getDataListFilters = async () => {
    ...
    const requestUrl = `ec2-54-179-0-126.ap-southeast-1.compute.amazonaws.com:4000/donUngTuyens/donUngTuyenTiemNang?${paramsString}`;
    try {
  ...
  useEffect(() => {
    const getTotalApplication = async () => {
      const requestUrl = `ec2-54-179-0-126.ap-southeast-1.compute.amazonaws.com:4000/donUngTuyens/demDonUngTuyenTiemNang`;
      try {
  ...
  const handleAddButtonClickDelete = async (id) => {
    try {
      const requestUrl = `ec2-54-179-0-126.ap-southeast-1.compute.amazonaws.com:4000/donUngTuyens/${id}`;
  ...
  const handleAddButtonClickTalent = async (id) => {
    try {
      const requestUrl = `ec2-54-179-0-126.ap-southeast-1.compute.amazonaws.com:4000/donUngTuyens/themDonUngTuyenTiemNang/${id}`;
